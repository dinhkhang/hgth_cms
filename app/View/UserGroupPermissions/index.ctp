...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-sm-4">
        <div class="title-action">
            <a class="btn btn-info" href="<?php echo Router::url(array('action' => 'autoGenerate')) ?>">
                <i class="fa fa-refresh"></i> <span><?php echo __('user_group_permission_autogenerate_title') ?></span>
            </a>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                echo $this->Form->input('name', array(
                    'div' => false,
                    'class' => 'form-control',
                    'label' => __('user_group_permission_name'),
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                echo $this->Form->input('code', array(
                    'div' => false,
                    'class' => 'form-control',
                    'label' => __('user_group_permission_code'),
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                echo $this->Form->input('module', array(
                    'div' => false,
                    'class' => 'form-control',
                    'label' => __('user_group_permission_module'),
                ...
                <thead>
                    <tr>
                        <?php if (empty($list_data)): ?>
                            ...
                            <th><?php echo __('user_group_permission_name') ?></th>
                            <th><?php echo __('user_group_permission_code') ?></th>
                            <th><?php echo __('user_group_permission_module') ?></th>
                            <th><?php echo __('user_group_permission_description') ?></th>
                            <th><?php echo __('user_group_permission_order') ?></th>
                            <th><?php echo __('operation') ?></th>
                        <?php else: ?>
                            <th><?php echo __('no') ?></th>
                            <th><?php echo $this->Paginator->sort('name', __('user_group_permission_name')); ?></th>
                            <th><?php echo $this->Paginator->sort('code', __('user_group_permission_code')); ?></th>
                            <th><?php echo $this->Paginator->sort('module', __('user_group_permission_module')); ?></th>
                            <th><?php echo __('user_group_permission_description') ?></th>
                            <th><?php echo $this->Paginator->sort('order', __('user_group_permission_order')); ?></th>
                            <th><?php echo __('operation') ?></th>
                        <?php endif; ?>
                    </tr>
                </thead>
                    ...
                    <?php if (!empty($list_data)): ?>
                        ...
                        <?php foreach ($list_data as $item): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $item[$model_name]['order'] ?></td>
                                <td>
