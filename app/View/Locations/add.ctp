        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                ...
                <div class="form-group <?php echo $name_err_class ?>">
                    <label
                        class="col-sm-2 control-label"><?php echo __('location_name') ?><?php echo $this->element('required') ?></label>
                ...
                <div class="form-group <?php echo $name_err_class ?>">
                    <label
                        class="col-sm-2 control-label"><?php echo __('location_country_code') ?><?php echo $this->element('required') ?></label>
                ...
                <div class="form-group <?php echo $name_err_class ?>">
                    <label
                        class="col-sm-2 control-label"><?php echo __('location_region') ?><?php echo $this->element('required') ?></label>
                ...
                <div class="form-group <?php echo $address_err_class ?>">
                    <label
                        class="col-sm-2 control-label"><?php echo __('location_address') ?><?php echo $this->element('required') ?></label>
                ...
                <div class="form-group <?php echo $latitude_err_class ?>">
                    <label
                        class="col-sm-2 control-label"><?php echo __('location_latitude') ?><?php echo $this->element('required') ?></label>
                ...
                <div class="form-group <?php echo $longitude_err_class ?>">
                    <label
                        class="col-sm-2 control-label"><?php echo __('location_longitude') ?><?php echo $this->element('required') ?></label>
