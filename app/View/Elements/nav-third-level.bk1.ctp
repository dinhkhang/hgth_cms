                ...
                foreach ($level1_items as $level1_item):
                        ...
                        <?php else: ?>
                                ...
                                if (
                                        ...
                                        $active_level2_clss = "";
                                        if (
                                                in_array($active_controller, $level2_controller) && empty($level2_header['?'])
                                        ) {
                                        ...
                                        if (
                                                in_array($active_controller, $level2_controller) &&
                                                !empty($level2_header['?']) &&
                                                !empty(array_intersect($this->request->query, $level2_header['?']))
                                        ) {
